...
const projects = [
    ...
    },
    {
        id:2,
        title: "GraspIQ",
        description: "GraspIQ, an AI study assistant integrated directly into Canvas LMS through a Chrome extension, using Claude's API with a custom tool-use agent to generate study guides, practice tests, and course-grounded chat answers, featuring a Next.js web app and a separate Dockerized backend deployed on Render.",
        image: "/projects/icon128.png",
        tags: ["Next.js", "TypeScript", "Claude API", "Chrome Extension", "Docker"],
        demoUrl: "https://grasp-iq-pi.vercel.app",
    },
    {
        id:3,
        title: "FitAI",
