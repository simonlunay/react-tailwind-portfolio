...
const projects = [
    {
        ...
        description: "A full stack website built for a local business in order to look more modern and all the business to add used parts for sale.",
        image: "/projects/project1.png",
        tags: ["HTML/CSS", "JavaScript", "Node.js", "SQL"],
        demoUrl: "https://jclequipment.com",
        githubUrl: "https://github.com/simonlunay/JCL-Web",
    ...
    },
    {
        ...
        tags: ["Electrical Engineering", "Group work"],
        demoUrl: "#",
        githubUrl: "#",
                     ...
                     <div className="p-6">
                        ...
                        <div className="flex justify-between items-center">
                                <div className="flex space-x3">
                                    <a href= {project.demoUrl} target="_blank" className="text-foreground/80 hover:text-primary transition-colors duration-300 p-2"><ExternalLink size={20}/></a>
                                    <a href= {project.githubUrl} target="_blank" className="text-foreground/80 hover:text-primary transition-colors duration-300 p-2"><Github size={20}/></a>
                                </div>
                     </div>
                        </div>
                    </div>
